...
np.save('formant_training_set_features.npy', X_train_features)
np.save('formant_development_set_features.npy', X_dev_features)
np.save('formant_test_set_features.npy', X_test_features)
