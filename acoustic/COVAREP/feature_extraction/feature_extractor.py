...
np.save('COVAREP_training_set_features.npy', X_train_features)
np.save('COVAREP_development_set_features.npy', X_dev_features)
np.save('COVAREP_test_set_features.npy', X_test_features)
