...
np.save('facial_landmarks_training_set_features.npy', X_train_features)
np.save('facial_landmarks_development_set_features.npy', X_dev_features)
np.save('facial_landmarks_test_set_features.npy', X_test_features)
