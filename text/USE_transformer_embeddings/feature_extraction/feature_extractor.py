...
np.save('text_training_set_features.npy', X_train_features)
np.save('text_development_set_features.npy', X_dev_features)
np.save('text_test_set_features.npy', X_test_features)
